...
>(
  (
    { title, isRequire, error, titleColor = "secondary-gray-950", ...props },
    ref
  ) => {
    return (
      <div className="w-full flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-2">
          <textarea
            ref={ref}
            className={clsx(
              "resize-none border border-econdary-gray-300 rounded-md text-sm px-3 py-2 disabled:opacity-100",
              {
                "border-urgent-02": error,
                "placeholder:text-secondary-gray-300": !props.value,
              }
            )}
            {...props}
          />
